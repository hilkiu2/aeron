...
//         lastBidSeen = currentWinningPrice;
...
//             winningCustomerId + ", " + winningPrice + ", " + bidSucceed + ")");
//     }
...
//                 final long price = ThreadLocalRandom.current().nextInt(50, 110);
//                 final long customerId = ThreadLocalRandom.current().nextInt(1, 11);
//                 final long correlationId = sendBid(aeronCluster, customerId, price);
...
//         printOutput("Final Winning Customer ID: " + winningCustomerId + ", Winning Price: " + winningPrice);
//     }

//     // tag::publish[]
//     private long sendBid(final AeronCluster aeronCluster, final long customerId, final long price)
//     {
